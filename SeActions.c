...
void CallCallbacksAction(widget) Widget widget;
{ XtCallCallbacks(widget, XtNdestroyCallback, NULL); }

void BeepAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void CloseWindowAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void DialEntriesAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
  ...
  if (strcmp(*param, "Default"))
    TopDial(dialWidget, (XtPointer)*param);
  else
    TopDial(dialWidget, (XtPointer)qres.defaultPhoneEntries);
}

void DivertFileAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
  void DivertFile(), ExecDivertFile();
  ...
  if (*numParam == 0)
    ...
    ExecDivertFile(widget, *param);
}

void DoNothingAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{ CheckNumParam(0); }

void EchoAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void FileTransferAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void IconifyWindowAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void HangupAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void ManualDialAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
  void ManualDial(), ExecManualDial();
  ...
  if (*numParam == 0)
    ...
    ExecManualDial(widget, *param);
}

void MessageAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void OpenWindowAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void QuitAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void RestartTerminalAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void RunScriptAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
  void DialogRunScript(), RunScript();
...
void SetAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void ShellCommandAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void SleepAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void TransmitAction(widget, event, param, numParam) Widget widget;
XEvent *event;
String *param;
Cardinal *numParam;
{
...
void DispatchActions(intData, stringData, widget) int intData;
String stringData;
Widget widget;
{
  int SeAppMSleep();
  ...
  static Boolean actionRunning = False, prevActionAsync = False, startup = True;
  static Widget actionWidget;
  static String actionStack = "";

  void (*actionProc)();
  static char actionName[SM_BUF], args[SM_BUF][SM_BUF];
  ...
  case ACTION_ARGS_END:
    ...
    for (i = 0; (actionProc = actionTable[i].actionProc) &&
                strcmp(actionName, actionTable[i].actionKeyWord);
         i++)
      ;
  ...
  case ACTION_DISPATCH:
    ...
    if (startup) {
      startup = False;
      startScript = XtNewString(
          FmtString("Message(\"Welcome to Seyon version %s.%s\"); %s", VERSION,
                    REVISION, "RestartTerminal();"));
...
void DispatchActionsCallback(widget, clientData) XtPointer widget;
